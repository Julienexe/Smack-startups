...
(function ($) {
    ...
    const ssMobileMenu = function () {
        ...
        const $siteBody = $("body");
        const $dropdownbtn = $('.s-header__nav .dropdown');
        const $dropdowncontent = $('.s-header__nav .dropdown-content');

        $toggleButton.on('click', function (event) {
            event.preventDefault();
            $toggleButton.toggleClass('is-clicked');
            $siteBody.toggleClass('menu-is-open');
            //replace class of dropdown button and drop down content
            if (!($dropdownbtn.hasClass('accordion'))) {
                $dropdownbtn.removeClass('dropdown');
                $dropdowncontent.removeClass('dropdown-content');
                $dropdownbtn.toggleClass('accordion');
                $dropdowncontent.toggleClass('panel');
                ssMobileMenuAccordion();
            }
        });
    ...
    //add event listener for click to accordion class


    const ssMobileMenuAccordion = function () {
